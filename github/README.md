...
1. Install the GitHub App configured for your codyx-orchestrator deployment. Make sure it is installed on the target repository.
   ...
   jobs:
     codyx:
       ...
       steps:
         ...
         - name: Run codyx
           uses: mufasa1611/codyx-orchestrator/github@dev
           env:
...
This is an early release. If you encounter issues or have feedback, please create an issue at https://github.com/mufasa1611/codyx-orchestrator/issues.
...
2. Run:
   ...
   MODEL=anthropic/claude-sonnet-4-20250514 \
     ...
     bun /path/to/codyx-orchestrator/github/index.ts
   ```
   ...
   - `/path/to/codyx-orchestrator`: Path to your cloned codyx-orchestrator repo. `bun /path/to/codyx-orchestrator/github/index.ts` runs your local version of `codyx`.
