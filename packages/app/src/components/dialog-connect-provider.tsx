        ...
        <Switch>
          <Match when={provider().id === "cody"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.codyZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.codyZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.codyZen.visit.prefix")}
                <Link href="https://cody.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.codyZen.visit.link")}
                </Link>
                {language.t("provider.connect.codyZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
