...
beforeAll(async () => {
  ...
  mock.module("@cody/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cody/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cody/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cody/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
