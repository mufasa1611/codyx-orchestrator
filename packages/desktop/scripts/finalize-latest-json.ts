...
const releaseId = process.env.CODY_RELEASE
if (!releaseId) throw new Error("CODY_RELEASE is required")
...
const macxTarGz = "cody-desktop-mac-x64.app.tar.gz"
const macaTarGz = "cody-desktop-mac-arm64.app.tar.gz"
