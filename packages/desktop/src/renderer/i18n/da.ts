export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Cody",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Cody er blevet downloadet. Vil du installere den og genstarte?",
