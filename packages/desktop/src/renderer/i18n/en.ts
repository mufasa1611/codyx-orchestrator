export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Cody",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Cody has been downloaded, would you like to install it and relaunch?",
