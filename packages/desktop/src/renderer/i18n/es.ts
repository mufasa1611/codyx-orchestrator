export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Cody",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Cody. ¿Quieres instalarla y reiniciar?",
