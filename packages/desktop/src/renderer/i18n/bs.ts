export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Cody-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Cody-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
