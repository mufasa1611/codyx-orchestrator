export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Cody",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Cody er lastet ned. Vil du installere den og starte på nytt?",
