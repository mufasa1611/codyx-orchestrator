export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Cody",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Cody a été téléchargée. Voulez-vous l'installer et redémarrer ?",
