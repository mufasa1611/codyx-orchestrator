export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Cody",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Cody wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
