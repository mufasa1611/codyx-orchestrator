---
title: Zen
description: Curated list of models provided by Cody.
---
...
Cody Zen is a list of tested and verified models provided by the Cody team.

:::note
Cody Zen is currently in beta.
:::

Zen works like any other provider in Cody. You login to Cody Zen and get
...
:::tip
We tested a select group of models and providers that work well with Cody.
:::
...
Cody Zen is an AI gateway that gives you access to these models.

---

## How it works

Cody Zen works like any other provider in Cody.

1. You sign in to **<a href={console}>Cody Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Cody Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Cody config
uses the format `cody/<model-id>`. For example, for GPT 5.5, you would
use `cody/gpt-5.5` in your config.
...
- MiniMax M2.5 Free is available on Cody for a limited time. The team is using this time to collect feedback and improve the model.
- Ling 2.6 Flash Free is available on Cody for a limited time. The team is using this time to collect feedback and improve the model.
- Hy3 Preview Flash Free is available on Cody for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on Cody for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Cody for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Cody as well.
