...
description: Brug Cody i enhver ACP-kompatibel editor.
---

Cody understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge Cody via ACP, konfigurer din editor til at køre kommandoen `cody acp`.

Kommandoen starter Cody som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'Cody'-agent i AI Chat-agentvælgeren.
...
For at bruge Cody som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge Cody som ACP-agent til chat.
...
Cody fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din Cody-konfiguration
