...
Der er to typer agenter i Cody; primære agenter og subagenter.
...
Cody leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Cody leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Cody leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `cody.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Cody modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Cody-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Cody-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Cody Zen](/docs/zen), vil du bruge `cody/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `cody models` for at se en liste over de tilgængelige modeller.
:::
