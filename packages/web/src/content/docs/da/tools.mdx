...
Her er alle de innebygde verktøyene som er tilgængelige i Cody.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Cody-leverandøren eller når miljøvariabelen `CODY_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
