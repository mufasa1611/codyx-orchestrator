---
title: Zen
description: Udvalgt liste over modeller leveret af Cody.
---
...
Cody Zen er en liste over testede og verificerede modeller leveret af Cody-teamet.

:::note
Cody Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i Cody. Du logger ind på Cody Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Cody.
:::
...
Cody Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Cody Zen fungerer som enhver anden udbyder i Cody.

1. Du logger ind på **<a href={console}>Cody Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Cody Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Cody-konfiguration
bruger formatet `cody/<model-id>`. For eksempel ville du for GPT 5.5
bruge `cody/gpt-5.5` i din konfiguration.
...
- MiniMax M2.5 Free er tilgængelig på Cody i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling 2.6 Flash Free er tilgængelig på Cody i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Preview Free er tilgængelig på Cody i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på Cody i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Cody i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Cody også.
