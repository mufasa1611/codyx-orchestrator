...
Cody Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

:::note
Cody Go er i øjeblikket i beta.
:::

Go fungerer som enhver anden udbyder i Cody. Du abonnerer på Cody Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Cody.
:::
...
Cody Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

Cody Go fungerer som enhver anden udbyder i Cody.

1. Du logger ind på **<a href={console}>Cody Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `Cody Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på Cody Go.
:::
...
Cody Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din Cody config
bruger formatet `cody-go/<model-id>`. For eksempel for Kimi K2.6, vil du
bruge `cody-go/kimi-k2.6` i din config.
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Cody.
