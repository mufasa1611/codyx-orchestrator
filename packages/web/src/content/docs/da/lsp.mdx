---
title: LSP-servere
description: Cody integreres med dine LSP-servere.
---

Cody integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Cody leveres med flere indbyggede LSP-servere til populære sprog:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din cody-konfiguration.
