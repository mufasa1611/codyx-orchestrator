---
title: Zen
description: Lista seleccionada de modelos proporcionada por Cody.
---
...
Cody Zen es una lista de modelos probados y verificados proporcionada por el equipo de Cody.

:::note
Cody Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en Cody. Inicias sesión en Cody Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Cody.
:::
...
Cody Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Cody Zen funciona como cualquier otro proveedor en Cody.

1. Inicias sesión en **<a href={console}>Cody Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Cody Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Cody
usa el formato `cody/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`cody/gpt-5.5` en tu configuración.
...
- MiniMax M2.5 Free está disponible en Cody por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ling 2.6 Flash Free está disponible en Cody por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Hy3 Preview Flash Free está disponible en Cody por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en Cody por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Cody por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Cody.
