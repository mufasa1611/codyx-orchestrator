...
Con Cody puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Cody usa nuestro propio tema `cody`.
...
Cody viene con varios temas integrados.
...
- Quiere que Cody coincida con la apariencia de su terminal
...
Cody admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/cody/themes/*.json` o `$XDG_CONFIG_HOME/cody/themes/*.json`
