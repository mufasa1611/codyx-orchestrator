...
Puede agregar comandos personalizados a través de la configuración Cody o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Cody [config](/docs/config):
...
cody incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
