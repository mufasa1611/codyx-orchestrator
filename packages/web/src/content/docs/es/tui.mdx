---
title: TUI
description: Usando la interfaz de usuario del terminal Cody.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cody proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Cody se inicia TUI para el directorio actual.
...
Cuando utilice Cody TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Cody. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Esto es independiente de `cody.json`, que configura el comportamiento del servidor/tiempo de ejecución.
