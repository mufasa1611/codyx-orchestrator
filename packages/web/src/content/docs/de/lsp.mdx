---
title: LSP Server
description: Cody lässt sich in Ihren LSP-Server integrieren.
---

Cody lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

Cody verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn Cody eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Cody-Konfiguration anpassen.
