---
title: Teilen
description: Teile Cody-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Cody-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Cody Folgendes:
...
Cody hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Cody den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`cody.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du cody in deiner Organisation einsetzt.
