...
description: Verwenden Sie Cody in jedem ACP-kompatiblen Editor.
---

Cody unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Cody über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `cody acp`.

Der Befehl startet Cody als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Cody“ in der AI Chat Agent Selector.
...
Um Cody als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Cody als ACP-Agent für den Chat verwendet wird.
...
Cody funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Cody-Konfiguration konfiguriert sind
