...
Możesz zdefiniować polecenia w `cody.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji cody:
...
- Globalnie: `~/.config/cody/commands/`
...
cody zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
