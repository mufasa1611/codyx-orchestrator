---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala cody.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

cody zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie cody uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI cody, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do cody. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Jest to oddzielny plik od `cody.json`, który konfiguruje zachowanie serwera/runtime.
