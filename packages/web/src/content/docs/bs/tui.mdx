---
title: TUI
description: Korištenje korisničkog interfejsa Cody terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cody pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Cody pokreće TUI za trenutni direktorij.
...
Kada koristite Cody TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Cody. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Cody. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `cody.json`, koji konfiguriše ponašanje servera/izvršavanja.
