...
تتيح مهارات الوكيل لـ Cody اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث Cody في هذه المواقع:

- إعدادات المشروع: `.cody/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/cody/skills/<name>/SKILL.md`
...
بالنسبة لمسارات المشروع المحلية، يتدرج Cody صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
كما تُحمَّل التعريفات العامة أيضاً من `~/.config/cody/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
يعرض Cody المهارات المتاحة في وصف أداة `skill`.
...
تحكم في المهارات التي يمكن للوكلاء الوصول إليها باستخدام صلاحيات مبنية على أنماط داخل `cody.json`:
