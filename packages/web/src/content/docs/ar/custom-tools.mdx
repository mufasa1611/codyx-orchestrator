...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في cody.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في cody مثل `read` و`write` و`bash`.
...
- أو عالميا بوضعها في `~/.config/cody/tools/`.
