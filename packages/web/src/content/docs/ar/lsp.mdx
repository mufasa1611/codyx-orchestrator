---
title: خوادم LSP
description: يتكامل Cody مع خوادم LSP لديك.
---

يتكامل Cody مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Cody مع عدة خوادم LSP مدمجة للغات الشائعة:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات cody.
