...
يوجد نوعان من الوكلاء في Cody: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Cody مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Cody مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Cody مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `cody.json`:
...
إذا لم يتم تحديد temperature، يستخدم Cody القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Cody العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Cody الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Cody Zen](/docs/zen)، فستستخدم `cody/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `cody models` لعرض قائمة بالنماذج المتاحة.
:::
