---
title: Server LSP
description: Cody si integra con i tuoi server LSP.
---

Cody si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

Cody include diversi server LSP integrati per linguaggi popolari:
...
Puoi personalizzare i server LSP tramite la sezione `lsp` nella configurazione di cody.
