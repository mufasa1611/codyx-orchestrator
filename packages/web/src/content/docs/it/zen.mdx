---
title: Zen
description: Lista curata di modelli fornita da Cody.
---
...
Cody Zen è un elenco di modelli testati e verificati forniti dal team di Cody.

:::note
Cody Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in Cody. Accedi a Cody Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Cody.
:::
...
Cody Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Cody Zen funziona come qualsiasi altro provider in Cody.

1. Accedi a **<a href={console}>Cody Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Cody Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Cody
usa il formato `cody/<model-id>`. Per esempio, per GPT 5.5, useresti
`cody/gpt-5.5` nella tua config.
...
- MiniMax M2.5 Free è disponibile su Cody per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling 2.6 Flash Free è disponibile su Cody per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Hy3 Preview Flash Free è disponibile su Cody per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su Cody per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Cody per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Cody.
