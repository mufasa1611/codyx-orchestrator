...
description: Crea strumenti che l'LLM puo chiamare in cody.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di cody come `read`, `write` e `bash`.
...
- Oppure in globale, mettendoli in `~/.config/cody/tools/`.
