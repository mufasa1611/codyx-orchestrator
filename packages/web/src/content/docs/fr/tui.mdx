---
title: TUI
description: Utilisation de l’interface utilisateur du terminal Cody.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Cody fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de Cody démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le Cody TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à Cody. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Ceci est séparé de `cody.json`, qui configure le comportement du serveur/d'exécution.
