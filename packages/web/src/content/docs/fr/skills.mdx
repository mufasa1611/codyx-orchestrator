...
Les compétences d'agent permettent à Cody de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Cody recherche ces emplacements :

- Configuration du projet : `.cody/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/cody/skills/<name>/SKILL.md`
...
Pour les chemins locaux du projet, Cody remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Les définitions globales sont également chargées à partir de `~/.config/cody/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Cody répertorie les compétences disponibles dans la description de l'outil `skill`.
...
Contrôlez les compétences auxquelles les agents peuvent accéder à l'aide d'autorisations basées sur des modèles dans `cody.json` :
...
**Pour les agents intégrés** (dans `cody.json`) :
