---
title: LSP-servere
description: cody integreres med LSP-serverne dine.
---

Cody integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Cody kommer med flere innebygde LSP-servere for populære språk:
...
Når cody åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Cody-konfigurasjonen.
