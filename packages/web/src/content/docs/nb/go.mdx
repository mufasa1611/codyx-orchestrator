...
Cody Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
Cody Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i Cody. Du abonnerer på Cody Go og
...
Cody Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Cody Go fungerer som enhver annen leverandør i Cody.

1. Du logger inn på **<a href={console}>Cody Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Cody Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Cody Go.
:::
...
Cody Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Cody-konfigurasjon
bruker formatet `cody-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `cody-go/kimi-k2.6` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Cody også.
