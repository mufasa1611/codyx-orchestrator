---
title: Zen
description: Utvalgt liste over modeller levert av Cody.
---
...
Cody Zen er en liste over testede og verifiserte modeller levert av Cody-teamet.

:::note
Cody Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i Cody. Du logger inn på Cody Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Cody.
:::
...
Cody Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Cody Zen fungerer som enhver annen leverandør i Cody.

1. Du logger inn på **<a href={console}>Cody Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Cody Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Cody-konfigurasjonen din
bruker formatet `cody/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `cody/gpt-5.5` i konfigurasjonen din.
...
- MiniMax M2.5 Free er tilgjengelig på Cody i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling 2.6 Flash Free er tilgjengelig på Cody i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Hy3 Preview Free er tilgjengelig på Cody i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Cody i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Cody i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Cody også.
