...
Agentferdigheter lar Cody oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
cody søker etter disse stedene:

- Prosjektkonfigurasjon: `.cody/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/cody/skills/<name>/SKILL.md`
...
For prosjektlokale stier går cody opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
Globale definisjoner lastes også inn fra `~/.config/cody/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
cody viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `cody.json`:
...
**For innebygde agenter** (i `cody.json`):
