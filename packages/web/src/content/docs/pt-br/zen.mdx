---
title: Zen
description: Lista selecionada de modelos fornecidos pelo Cody.
---
...
O Cody Zen é uma lista de modelos testados e verificados fornecidos pela equipe do Cody.

:::note
O Cody Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no Cody. Você faz login no Cody Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o Cody.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o Cody.
:::
...
O Cody Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O Cody Zen funciona como qualquer outro provedor no Cody.

1. Você faz login no **<a href={console}>Cody Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Cody Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do Cody usa o formato `cody/<model-id>`. Por exemplo, para GPT 5.5, você usaria `cody/gpt-5.5` na sua configuração.
...
- MiniMax M2.5 Free está disponível no Cody por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Ling 2.6 Flash Free está disponível no Cody por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Hy3 Preview Free está disponível no Cody por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no Cody por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no Cody por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o Cody também.
