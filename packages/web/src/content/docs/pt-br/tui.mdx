---
title: TUI
description: Usando a interface de usuário de terminal cody.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O cody fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar cody inicia o TUI para o diretório atual.
...
Ao usar o TUI do cody, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao cody. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Isso é separado do `cody.json`, que configura o comportamento do servidor/runtime.
