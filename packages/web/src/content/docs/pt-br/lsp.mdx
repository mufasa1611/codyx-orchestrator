...
description: O cody integra-se aos seus servidores LSP.
---

O cody integra-se ao seu Protocolo de Servidor de Linguagem (LSP) para ajudar o LLM a interagir com sua base de código. Ele usa diagnósticos para fornecer feedback ao LLM.

---

## Integrados

O cody vem com vários servidores LSP integrados para linguagens populares:
...
Quando o cody abre um arquivo, ele:
...
Você pode personalizar os servidores LSP através da seção `lsp` na sua configuração do cody.
