---
title: Paylasim
description: cody konusmalarini genel baglantilarla paylasin.
---

cody'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda cody:
...
cody, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak cody manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `cody.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda cody kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
