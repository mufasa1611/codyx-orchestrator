...
description: Cody, LSP sunucularınızla bütünleşir.
---

Cody, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

Cody, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP sunucularını, cody yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
