---
title: Zen
description: cody tarafından sağlanan seçilmiş modeller listesi.
---
...
Cody Zen, Cody ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

:::note
Cody Zen şu anda beta olarak mevcut.
:::

Zen, Cody'daki diğer sağlayıcılar gibi çalışır. Cody Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Cody kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Cody ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Cody Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Cody Zen, Cody'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Cody Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Cody Zen'i seçin ve API anahtarınızı yapıştırın.
...
Cody yapılandırmanızdaki [model id](/docs/config/#models) `cody/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `cody/gpt-5.5` kullanırsınız.
...
- MiniMax M2.5 Free, sınırlı bir süre için Cody'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling 2.6 Flash Free, sınırlı bir süre için Cody'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Hy3 Preview Free, sınırlı bir süre için Cody'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için Cody'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Cody'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Cody Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Cody ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
