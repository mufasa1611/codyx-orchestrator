...
Ajan becerileri, cody'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
cody su konumlari tarar:

- Proje konfigurasyonu: `.cody/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/cody/skills/<name>/SKILL.md`
...
Proje yerel yollarinda cody, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
...
Genel tanimlar da `~/.config/cody/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
cody, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`cody.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`cody.json` icinde):
