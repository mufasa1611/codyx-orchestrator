---
title: Özel Araçlar
description: LLM'un cody'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. cody'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Veya küresel olarak bunları `~/.config/cody/tools/` içine yerleştirerek.
