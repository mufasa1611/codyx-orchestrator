...
import { IconCody } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "cody/session/message-v2"
import type { Message } from "cody/session/message"
import type { Session } from "cody/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.cody_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.cody_name}>
                    <IconCody width={16} height={16} />
                  </div>
