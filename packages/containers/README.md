...
```
REGISTRY=ghcr.io/mufasa1611/codyx-orchestrator TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/mufasa1611/codyx-orchestrator TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/mufasa1611/codyx-orchestrator/build/bun-node:24.04
```
