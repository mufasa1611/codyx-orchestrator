...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips cody-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-cody-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-cody-directory")).toBeNull()
      expect(result.get("x-cody-workspace")).toBeNull()
