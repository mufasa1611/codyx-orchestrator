...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/cody.git")).toEqual({ owner: "sst", repo: "cody" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/cody")).toEqual({ owner: "sst", repo: "cody" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/cody.git")).toEqual({ owner: "sst", repo: "cody" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/cody")).toEqual({ owner: "sst", repo: "cody" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/cody.git")).toEqual({ owner: "sst", repo: "cody" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/cody")).toEqual({ owner: "sst", repo: "cody" })
})
