...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODY_CALLER", () => {
    process.env["CODY_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODY_CALLER", () => {
    process.env["CODY_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODY_CALLER", () => {
    process.env["CODY_CALLER"] = "unknown"
