import type * as SDK from "@cody/sdk/v2"
...
const disabled = process.env["CODY_DISABLE_SHARE"] === "true" || process.env["CODY_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@cody/ShareNext") {}
