    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          "cody-agent-list": Tool.init(remoteLs),
          "cody-agent-read": Tool.init(remoteRead),
          "cody-agent-write": Tool.init(remoteWrite),
          "cody-agent-exec": Tool.init(remoteBash),
        ...
        return {
          ...
          builtin: [
            ...
            tool.search,
            tool.skill,
            tool["cody-agent-list"],
            tool["cody-agent-read"],
            tool["cody-agent-write"],
            tool["cody-agent-exec"],
            tool.patch,
