  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all codyx sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific codyx session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new codyx session for interacting with AI assistants and managing conversations.",
      ...
      async (c) =>
        jsonRequest("SessionRoutes.create", c, function* () {
          ...
          return yield* svc.create(body).pipe(Effect.provideService(UserRef, userId))
        }),
    )
    .delete(
      "/:sessionID",
    ...
    .post(
      ...
      async (c) =>
        jsonRequest("SessionRoutes.fork", c, function* () {
          ...
          const svc = yield* Session.Service
          return yield* svc.fork({ ...body, sessionID }).pipe(Effect.provideService(UserRef, userId))
        }),
    )
    .post(
      "/:sessionID/abort",
    ...
    .post(
      ...
      async (c) =>
        jsonRequest("SessionRoutes.command", c, function* () {
          ...
          const userId = Jwt.userIdFromBearer(c.req.header("Authorization"))
          const svc = yield* SessionPrompt.Service
          return yield* svc.command({ ...body, sessionID }).pipe(Effect.provideService(UserRef, userId))
        }),
    )
    .post(
      "/:sessionID/shell",
      ...
      async (c) =>
        jsonRequest("SessionRoutes.shell", c, function* () {
          ...
          const userId = Jwt.userIdFromBearer(c.req.header("Authorization"))
          const svc = yield* SessionPrompt.Service
          return yield* svc.shell({ ...body, sessionID }).pipe(Effect.provideService(UserRef, userId))
        }),
    )
    .post(
      "/:sessionID/revert",
