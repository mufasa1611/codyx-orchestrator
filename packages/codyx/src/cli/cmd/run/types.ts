...
import type { CodyClient, PermissionRequest, QuestionRequest, ToolPart } from "@cody/sdk/v2"
...
type PromptModel = Parameters<CodyClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<CodyClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<CodyClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<CodyClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<CodyClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<CodyClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<CodyClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<CodyClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<CodyClient["question"]["reject"]>[0]
