...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your codyx conversation",
  ...
  "Place TUI settings in your global config directory for all codyx sessions",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "codyx auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "codyx auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "codyx uses LSP servers for intelligent code analysis",
  "Create local tool definition files to add new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add local plugin files for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent codyx from reading sensitive files",
  "Use {highlight}codyx run{/highlight} for non-interactive scripting",
  "Use {highlight}codyx --continue{/highlight} to resume the last session",
  "Use {highlight}codyx run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}codyx serve{/highlight} for headless API access to codyx",
  "Use {highlight}codyx run --attach{/highlight} to connect to a running server",
  "Run {highlight}codyx upgrade{/highlight} to update to the latest version",
  "Run {highlight}codyx auth list{/highlight} to see all configured providers",
  "Run {highlight}codyx agent create{/highlight} for guided agent creation",
  "Use {highlight}/codyx{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}codyx github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/codyx fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/codyx{/highlight} on PR code lines for targeted code reviews",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors',
  "Create JSON theme files in your codyx themes directory",
  ...
  "Run {highlight}codyx debug config{/highlight} to troubleshoot configuration",
  ...
  "Use the codyx container image for containerized use when published",
  "Use {highlight}/connect{/highlight} with codyx for curated, tested models",
