 ...
 *   "@cody/ServerAuthConfig",
 *   {
 *     password: Config.string("CODY_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODY_SERVER_USERNAME").pipe(Config.withDefault("cody")),
 *   },
 * ) {}
 *
