...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CodyClient()" to fix this error.`)
    }
    return instance
  }
...
export class CodyClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CodyClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    CodyClient.__registry.set(this, args?.key)
  }
