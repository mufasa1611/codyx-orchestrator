...
- `Cody` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `cody` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Cody` in prose, `cody` only for exact technical identifiers
...
- Avoid changing `cody` to `Cody` inside commands, URLs, package names, or code literals
