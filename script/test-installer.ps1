...
Assert-Contains "script/launcher.ps1" 'Get-CodyxSparseCheckoutPaths[\s\S]*packages/slack[\s\S]*patches' "Standalone launcher slim checkout keeps required runtime workspace and patches"
Assert-Contains "script/launcher.ps1" 'Enable-CodyxSlimCheckout[\s\S]*sparse-checkout", "set"' "Standalone launcher can convert existing installs to slim checkout"
...
Assert-Contains "script/install.ps1" 'Get-CodyxSparseCheckoutPaths[\s\S]*packages/slack[\s\S]*patches' "Windows installer slim checkout keeps required runtime workspace and patches"
