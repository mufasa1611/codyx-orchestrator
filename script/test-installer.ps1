...
Assert-Contains "script/launcher.ps1" 'packages\\codyx\\node_modules\\drizzle-orm\\sqlite-core' "Standalone launcher repairs missing runtime dependencies"
...
Assert-Contains "codyx.cmd" 'packages\\codyx\\node_modules\\drizzle-orm\\sqlite-core' "CMD launcher repairs missing runtime dependencies"
