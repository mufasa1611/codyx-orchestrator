...
Assert-Contains "script/update-progress.ps1" 'Invoke-Native "git" @\("reset", "--hard", "origin/\$Branch"\)' "Repair script runs reset directly so Git errors stay visible"
...
Assert-Contains "packages/launcher/Program.cs" 'ShowLaunchChoices\(true\)' "Windows launcher shows choices after first-run setup"
Assert-Contains "packages/launcher/Program.cs" 'ShowLaunchChoices\(false\)' "Windows launcher shows choices after update checks"
