...
Assert-Contains "script/launcher.ps1" '\[switch\]\$RequireLicensePrompt' "Standalone launcher keeps license prompts opt-in"
Assert-Contains "script/launcher.ps1" '-not \$RequireLicensePrompt[\s\S]*"-AcceptLicense"' "Standalone launcher auto-accepts the installer license for zero-click exe installs"
