...
Assert-Contains "script/launcher.ps1" 'Install-PortableGit[\s\S]*MinGit-.\*-64-bit' "Standalone launcher falls back to portable MinGit when package managers are unavailable"
...
Assert-Contains "script/install.ps1" 'Install-PortableGit[\s\S]*MinGit-.\*-64-bit' "Windows installer falls back to portable MinGit when package managers are unavailable"
